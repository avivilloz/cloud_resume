...
def handler(event, context):
    ...
    try:
        ...
        message = f"Error fetching item from table. Table name: '{table_name}', Item key: {key}, Exception: {e}"
    ...
    try:
        ...
        message = f"Error updating item in table. Table name: '{table_name}', Item key: {key}, Attribute: {attribute}, Value: {count}, Exception: {e}"
        return get_response(status=500, body={"message": message})
